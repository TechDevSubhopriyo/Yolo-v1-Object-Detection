...
class kitti2voc:
    ...
    def convert_process(self):
        ...
        for filename in os.listdir(self.kitti_anat_path):
            ...
            image_file = self.image_path_src+image_name
            ...
            if count>0:
                PascalVocWriter_ins.save(self.voc_anat_path+filename.replace(".txt",".xml"))
                cv2.imwrite(image_path_dst+image_name,img)
                print(image_path_dst+image_name)

if __name__ =='__main__':
    
    Image_path_src = 'dataset_kitti/data_object_image_2/training/image_2/'
    image_path_dst = 'kitti/training/image/'
    Kitti_anat_path= 'dataset_kitti/data_object_label_2/training/label_2/'
    Voc_anat_path = 'kitti/training/label/'
